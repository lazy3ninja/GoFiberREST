...
import (
	...
	"example.com/hello/pkg/responses"
...
func DeleteCard(c *fiber.Ctx) error {
	...
	if result.DeletedCount < 1 {
		return c.Status(http.StatusNotFound).JSON(responses.CardResponse{
	...
	return c.Status(http.StatusCreated).JSON(responses.CardResponse{Status: http.StatusCreated, Message: "success", Data: "Card deleted succesfully"})
}
